package com.zhiqi.common.utils.reflect;
...
public class ReflectUtils
{
                                     ...
                                     final Object[] args)
    {
        ...
        catch (Exception e)
        {
            ...
            throw ConverterReflectionExceptionToUnchecked(msg, e);
        }
    }
        ...
        try
        {
            ...
            for (int i = 0; i < cs.length; i++)
            {
                if (args[i] != null && !args[i].getClass().equals(cs[i]))
                {
                    ...
                    {
                        args[i] = Converter.toBool(args[i]);
                    }
                }
            }
            return (E) method.invoke(obj, args);
     ...
     */
    public static RuntimeException ConverterReflectionExceptionToUnchecked(String msg, Exception e)
    {
